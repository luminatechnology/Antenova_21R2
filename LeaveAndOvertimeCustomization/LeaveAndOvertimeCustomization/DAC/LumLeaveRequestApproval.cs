...
{
    [Serializable]
    [PXCacheName("LumLeaveRequestApproval")]
    public class LumLeaveRequestApproval : IBqlTable, IAssignedMap
    {
        #region ApprovalID
        ...
        [PXSelector(typeof(Search<EPAssignmentMap.assignmentMapID, Where<EPAssignmentMap.entityType, Equal<LeaveAndOvertimeCustomization.Descriptor.AssignmentMapType.AssignmentMapTypeLumLeave>>>), SubstituteKey = typeof(EPAssignmentMap.name))]
