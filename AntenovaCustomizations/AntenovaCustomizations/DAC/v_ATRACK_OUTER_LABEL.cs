...
{
  [Serializable]
  [PXCacheName("v_ATRACK_OUTER_LABEL")]
    public class v_ATRACK_OUTER_LABEL : IBqlTable
    {
        #region GroupNowNbr
        [PXDBInt()]
        ...
        [PXDBInt()]
        [PXUIField(DisplayName = "Usr Shipment Split Line Nbr")]
        public virtual int? UsrShipmentSplitLineNbr { get; set; }
        public abstract class usrShipmentSplitLineNbr : PX.Data.BQL.BqlInt.Field<usrShipmentSplitLineNbr> { }
        #endregion
